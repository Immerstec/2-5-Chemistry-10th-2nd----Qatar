...
public class LiquidSystem1 : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        this.transform.Find("Liquid").GetComponent<MeshRenderer>().material.color = new Color(0.79607f, 0.88627f, 1);
        this.transform.Find("LiquidPouring").GetComponent<ParticleSystemRenderer>().material.color = new Color(0.79607f, 0.88627f, 1);
